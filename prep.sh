...
awk -v n=1 'NR==FNR{total=NR;next} FNR==total-n+1{exit} 1' ./lawnicons/app/src/main/res/xml/grayscale_icon_map.xml ./lawnicons/app/src/main/res/xml/grayscale_icon_map.xml >> temp.txt && mv temp.txt app/src/main/res/xml/grayscale_icon_map.xml
rm temp.txt
